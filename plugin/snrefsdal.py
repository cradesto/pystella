...
def coef_glens():  # see http://arxiv.org/abs/1510.05750
    a = {'ogu-g': {'time': {'S1': 0, 'S2': 8.7, 'S3': 5.1, 'S4': 18.8, 'SX': 311.},
         ...
         'bakl': {'time': {'S1': 0, 'S2': 1.1, 'S3': .7, 'S4': 13.6, 'SX': 0},  # sn_obs_refsdal_grav-lens.ipynb
                  'etime': {'S1': (0., 0.), 'S2': (.96, .96), 'S3': (1., 1.), 'S4': (1.7, 1.7), 'SX': (0, 0)},
                  'mag': {'S1': 1., 'S2': 1.14, 'S3': 1.03, 'S4': 0.38, 'SX': 1},
